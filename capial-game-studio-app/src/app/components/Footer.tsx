            ...
            <div className="w-full max-w-screen-xl mx-auto p-4 md:py-8">
                <div className="sm:flex sm:items-center sm:justify-between">
                    ...
                    <ul className="flex flex-wrap items-center mb-6 text-sm font-medium text-gray-500 sm:mb-0 dark:text-gray-400">
                        <li>
                            <button
                                className="mx-1 p-4 rounded-full backdrop-blur-lg border border-pink-500/20 bg-gradient-to-tr from-black/60 to-black/40 shadow-lg hover:shadow-2xl hover:shadow-red-500/30 hover:scale-110 hover:rotate-2 active:scale-95 active:rotate-0 transition-all duration-300 ease-out cursor-pointer hover:border-pink-500/50 hover:bg-gradient-to-tr hover:from-pink-500/10 hover:to-black/40 group relative overflow-hidden"
                            >
                                <div
                                ...
                                <div className="relative z-10">
                                    {/* <svg
                                    className=" bi bi-instagram w-7 h-7 fill-current text-pink-500 group-hover:text-pink-400 transition-colors duration-300"
                                    viewBox="0 0 576 512"
                ...
                <span className="block text-sm text-gray-500 sm:text-center dark:text-gray-400">© 2022-2025 <a href="#" className="hover:underline">CapialGameStudio™</a>. All Rights Reserved.</span>
            </div>
        </footer>
    )
}
