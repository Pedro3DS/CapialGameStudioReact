...
export default function Home() {
    return (
        <section className="flex flex-col md:flex-row items-center justify-center h-[75vh] md:h-[88vh] px-6 md:px-20 bg-gradient-to-b from-[#000] from-[0.5vh] via-transparent to-[#333] backdrop-blur-[1px] text-white relative  " id="#home">
